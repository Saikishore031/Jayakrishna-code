...
variable "avset_id" {
  default     = ""
  description = "Availbility Set ID"
}

variable "disk_size_gb" {
  default     = ""
  description = "Data disk dize in GB"
}
variable "data_disk_enable" {
  default     = ""
  description = "Enabled or Disable Data Disk"
}
variable "multi_nic" {
  default     = ""
  description = "Enable or Disable multiple nics"
}
variable "primary_nic_id" {
  default     = ""
  description = "Primary NIC ID"
}
